...
> Note: If you set a name here, it's also available in script via `window.Name`. You can use it to prefix console messages or use for titles on various dialog boxes.
