...
> Note: Only call this when text has changed otherwise it will flicker.
...
> Note: Check x, y positions have changed from last time otherwise it will flicker. If making the tooltip
