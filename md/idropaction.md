...
https://docs.microsoft.com/en-gb/windows/win32/com/dropeffect-constants
...
> Note: The example above does not take in to account playlist locks that prevent the
